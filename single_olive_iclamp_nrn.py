...
Components:
    ...
    cell (Type: cell)
    null (Type: include)
    iclamp0 (Type: pulseGenerator:  delay=0.6 (SI time) duration=0.2 (SI time) amplitude=0.0 (SI current))
...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt):
        ...
        h("objref Clamps_0")
        h("a_pop[0].axon { Clamps_0 = new iclamp0(0.500000) } ")
...
if __name__ == '__main__':
    ...
    ns = NeuronSimulation(tstop=1000 , dt=0.025)
